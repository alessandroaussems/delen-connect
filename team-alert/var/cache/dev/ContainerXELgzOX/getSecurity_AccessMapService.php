...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/nl/login'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/[a-z]+/admin'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPER_ADMIN'], NULL);
